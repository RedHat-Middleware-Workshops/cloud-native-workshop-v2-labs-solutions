// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties15
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties15#deploy_0
    RETURN
    ** label2
