// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$build7
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$build7#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    LDC (String) "io.quarkus.hibernate.orm.runtime.dialect.QuarkusPostgreSQL95Dialect"
