// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit6
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit6#deploy_0
    RETURN
    ** label2
