...
(
    ...
    ** label1
    ...
    LDC (String) "org.codehaus.plexus.classworlds.launcher.Launcher clean package -DskipTests -Dquarkus.profile=prod"
    // Method descriptor: (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    INVOKEINTERFACE java/util/Map#put
    POP
    ALOAD 4
...
"
    ...
    CHECKCAST java/util/Map
    LDC (String) "user.dir"
    LDC (String) "/Users/doh/redhat-middleware-workshops/cloud-native-workshop-v2-labs-solutions/m4/inventory-service"
    // Method descriptor: (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    INVOKEINTERFACE java/util/Map#put
    POP
    ALOAD 4
